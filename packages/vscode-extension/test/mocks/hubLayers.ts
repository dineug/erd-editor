...
/** The frame decoder a spec uses on raw text the hub wrote. */
export const decodeTestFrames = decodeFrames(Schema.Unknown);
...
export type MemorySocket = Socket.Socket;
export type { Mock };
