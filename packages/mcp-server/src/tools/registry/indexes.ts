...
const changeIndexNameAction$ = (
  ...
  function* ({ collections }) {
    ...
    yield indexActions.changeIndexNameAction({
      id: indexId,
...
const setIndexUniqueAction$ = (
  ...
  function* ({ collections }) {
    ...
    yield indexActions.changeIndexUniqueAction({
      id: indexId,
      tableId: index.tableId,
      value,
    });
...
const addIndexColumnOnceAction$ = (
  ...
  function* ({ collections }) {
    ...
    yield indexColumnActions$.addIndexColumnAction$(indexId, columnId);
  };
...
const removeIndexColumnByIdAction$ = (
  ...
  function* ({ collections }) {
    ...
    yield indexColumnActions$.removeIndexColumnAction$(
      indexId,
...
const setIndexColumnOrderAction$ = (
  ...
  function* ({ collections }) {
    ...
    yield indexColumnActions.changeIndexColumnOrderTypeAction({
      id: indexColumnId,
...
export const indexTools: readonly ActionTool[] = [
  {
    ...
    toActions: ({ tableId }) => [indexActions$.addIndexAction$(tableId)],
  },
  {
    ...
    args: [INDEX_ID],
    toActions: ({ indexId }) => [
      indexActions.removeIndexAction({ id: indexId }),
    ],
  },
  {
