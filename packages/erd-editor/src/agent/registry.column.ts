...
import type { ActionTool, ToolArg, ToolFocus } from '@/agent/registry';
...
const valueTool = (
  ...
  toActions: ({ tableId, columnId, value }) => [
    changeColumnValueAction$(focusType, tableId, columnId, value),
  ],
});
...
export const columnTools: readonly ActionTool[] = [
  {
    ...
    args: [TABLE_ID],
    toActions: ({ tableId }) => [addColumnAction$(tableId)],
  },
  {
    ...
    toActions: ({ tableId, columnIds }) => [
      removeColumnAction$(tableId, columnIds),
    ],
  },
  {
    ...
    args: [TABLE_ID, COLUMN_ID, TEXT_VALUE],
    toActions: ({ tableId, columnId, value }) => [
      changeColumnDataTypeAction$({ tableId, id: columnId, value }),
    ],
  },
  valueTool(
  ...
  flagTool({
    ...
    creator: changeColumnPrimaryKeyAction,
  ...
  flagTool({
    ...
    creator: changeColumnUniqueAction,
  ...
  flagTool({
    ...
    creator: changeColumnNotNullAction,
  ...
  flagTool({
    ...
    creator: changeColumnAutoIncrementAction,
  ...
  }),
  {
    ...
    toActions: ({ tableId, columnId, targetColumnId }) => [
      moveColumnAction({ id: columnId, tableId, targetId: targetColumnId }),
    ],
  },
];
