...
import { columnTools } from '@/agent/registry.column';
import { importTools } from '@/agent/registry.import';
import { indexTools } from '@/agent/registry.index';
import { memoTools } from '@/agent/registry.memo';
import { relationshipTools } from '@/agent/registry.relationship';
import { settingsTools } from '@/agent/registry.settings';
import { tableTools } from '@/agent/registry.table';
 ...
 * the MCP package. A snapshot path is a dot path whose bracketed argument
 * picks the list element with that id, as in tables[tableId].name.
 */
