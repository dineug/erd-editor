/**
 * https://github.com/radix-ui/themes/blob/main/packages/radix-ui-themes/src/styles/fonts.css
 */
const fonts = /* css */ `
  @font-face {
...
export const CodeFontFamily =
  "'Menlo', 'Consolas (Custom)', 'Bitstream Vera Sans Mono', monospace, 'Apple Color Emoji', 'Segoe UI Emoji'" as const;
