...
- `pnpm --filter @dineug/erd-editor-app e2e` builds the three workspace deps, then runs Chromium against `vp dev` (:5175) and `e2e/support/relay.mjs` (:5176). Never runs in CI.
