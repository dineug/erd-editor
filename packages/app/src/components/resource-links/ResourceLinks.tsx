...
import * as styles from './ResourceLinks.styles';
...
/**
 * The Editing Guide and GitHub, in a new tab, under the actions of an empty
 * viewer: the one row both / and /gdrive show when no document is open.
 */
