...
| `tools/vite/library-config.ts` | Typed factory for the seven standard library builds, the `workers: true` half a library that spawns one adds, and the shared task builder used by all nine library-mode packages |
